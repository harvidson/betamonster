...
const answersList = [
  ...
  },
  {
    ...
    user_id: 3,
    anser: 'The site\'s fine. But while we\'er talking politics, blast first (from politeness) England. . . . Luxury, sport, the famous English "Humour," the thrilling ascendancy and idée fixe of Class, producing the most Intense snobbery in the World; heavy stagnant pools of Saxon blood, incapable of any thing but the song of a frog, in home-counties: — these phenomena give England a peculiar distinction in the wrong sense, among the nations.'
